    ...
    app.innerHTML = `
        <div class="min-h-screen bg-gray-50">
            ...
            ? notifications
                .map(
                    notification => `
                    <div class="p-4 bg-white ${!notification.isRead ? 'bg-green-50' : ''
...
// Function to get notification colors
function getNotificationColor(color) {
    ...
    return colors[color] || colors.primary; // Default to primary if color not found
}
...
function renderHome() {
    app.innerHTML = `
        <div class="pb-16">
            ...
            .map(
                category => `
                        <button class="ripple flex-shrink-0 px-6 py-2 rounded-full ${category === 'All'
...
// Replace all instances of green with primary (blue)
// Here are the key changes needed:

// 1. Update status bar color
function renderStatusBar() {
    return `
        <div class="bg-primary status-bar"></div>
    `;
}
...
// Update your tailwind.config.js to include these custom colors:
